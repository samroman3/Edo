...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let eaze = DeveloperToolsSupport.ImageResource(name: "eaze", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "eaze" asset catalog image.
    static var eaze: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .eaze)
#else
        .init()
